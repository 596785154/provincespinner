...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter01 = new ArrayAdapter<Province>(this,
        ...
        spinner01.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                provence = provinces.get(position);
    ...
    public List<Province> getProvinces() throws XmlPullParserException,
            IOException {
        ...
        InputStream in = resources.openRawResource(R.raw.province_city_district);
